...
class ProductMatch(object):
    ...
    def __init__(self, ean=None, title=None):  # noqa: E501
        """ProductMatch - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProductMatch, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductMatch):
            return False
